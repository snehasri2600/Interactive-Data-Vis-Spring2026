...
1. Your data must be public, something that you can share publicly, or something that you can anonymize so it can be shared publicly. This is because your github repository is public and not restricted to members of this class, GC, or CUNY.
...
3. Submit your lab via email directly to me (ellie.frymire@gmail.com). Include:
...
<details>
  ...
  <ul>
    <li>Spatial (closest to areas of the worst contamination)</li>
    <li>Temporal (their activities align with pollution spikes)</li>
    <li>Biological (observed pollution levels match would-be fish mortality)</li>
    </ul>
  </div>
</details>
